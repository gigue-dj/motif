...
1. **Project name evaluation — resolve before v0.1.0.** Penciled in
   during the v0.0.4-alpha.5 audit pass. "morceau-db" collides with a
   preponderance of "morceau-db"-named databases and library tools in the
   wider market, especially in biostatistics / bioinformatics
   (sequence morceau-db discovery), where "morceau-db DB" is an entrenched
   ...
   in French; preserves the musical-vocabulary thread from "morceau-db"
   ...
   identifiers + docs); v0.0.4 ships under "morceau-db" because the
