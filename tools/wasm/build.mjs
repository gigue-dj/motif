...
const MOTIF_VERSION_TEXT = "Motif VERSION";
...
console.log(`Using ${THREADS} threads to build Motif.`);
console.log('Cleaning up...');
execSync("npm run clean", { stdio: "inherit" });
console.log('Building single-threaded version of Motif WebAssembly module...')
...
console.log("Building multi-threaded version of Motif WebAssembly module...");
...
console.log('Cleaning up...');
execSync("npm run clean exclude-package", { stdio: "inherit" });
console.log("Building Node.js version of Motif WebAssembly module...");
...
for (const line of lines) {
  if (line.includes(MOTIF_VERSION_TEXT)) {
...
execSync("tar -czf motif-wasm.tar.gz package", { cwd: path.resolve("."), stdio: "inherit" });
